...
export class RoutinesManager {
  ...
  saveForm() {
    ...
    this.save(); this.render(); document.getElementById('routineModal').close();
  }
  saveCurrentDay() {
  ...
  duplicateDay() {
    ...
    this.app.exercisesData[targetText].forEach(item => item.date = targetText); this.app.saveExercises(); alert('Entrenamiento duplicado.');
  }
  openApply(id) {
